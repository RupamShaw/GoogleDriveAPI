    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            Channel request = new Channel()
                    ...
                    .setType("web_hook")
                    .setAddress("https://2-dot-ggledrvsrvcaccnt.appspot.com/");
         /*  try{
            Channel ch= mService.changes().watch(request).execute();
           } catch (IOException e) {
               System.out.println("Something is wrong with instantiating new channel");
               e.printStackTrace();
           }
*/
/*
            Change change = mService.changes().get(String.valueOf((Integer.parseInt(changeId) - 1))).execute();
